 ...
 * @since  1.7
 */
public class Java7QuicksortKiller_backup implements Runnable {
...
//            hackedSort(a, p, great + 1, right, false, depth + 1);
    ...
    public void run() {
        ...
        */
        ...
        sb.append(a[a.length - 1] + System.lineSeparator());
        t1 = System.currentTimeMillis();
        //Arrays.sort(a.clone());
        t2 = System.currentTimeMillis();
        wr.print(sb);
    ...
    public static void main(String[] args) {
        new Thread(null, new Java7QuicksortKiller_backup(), "", 128*1024*1024).start();
    }
