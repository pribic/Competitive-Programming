...
public class dalexAnother
{
	public static void main(String[] args) throws Exception
	{
		long starttime = new Date().getTime();
		int[] scrambled = AntiQuicksort.killQuicksort(100000);
		System.out.println("Scrambling ended in " + (new Date().getTime() - starttime) + "ms with " + AntiQuicksort.pivots.size() + "pivots");
