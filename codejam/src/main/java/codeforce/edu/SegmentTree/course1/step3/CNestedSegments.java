...
import algoridhm.Template.SegmentTree;
 ...
 * @see <a href="https://codeforces.com/edu/course/2/lesson/4/3/practice/contest/274545/problem/C" target="_top">https://codeforces.com/edu/course/2/lesson/4/3/practice/contest/274545/problem/C</a>
 * @since 23/10/21 11:54 PM
 */
public class CNestedSegments {
      ...
      for (int tt = 1; tt <= T; tt++) {
        ...
        for (int i = 0; i < 2 * n; i++) {
          ...
          if (intervalStart.containsKey(intervalId)) {
            ...
            ans[intervalId] = st.get(startIdx, i).val;
            st.set(startIdx, 1);
