 ...
 * @see <a href="https://codeforces.com/contests/1676/problem/A" target="_top">https://codeforces.com/contests/1676/problem/A</a>
  ...
  public static void main(String[] args) {
    try (PrintWriter out = new PrintWriter(System.out)) {
      ...
      for (int tt = 1; tt <= T; tt++) {
        ...
        System.out.println(sum(n1) == sum(n2) ? "YES" : "NO");
